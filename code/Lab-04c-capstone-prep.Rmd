...
logistic_model_voice1 <- parkinsons_dataset %>% 
  glm(diagnosis ~ dur_unvoiced_stops1 + dur_unvoiced_stops2, family = binomial, data = .)
summary(logistic_model_voice1)

logistic_model_voice2 <- parkinsons_dataset %>% 
  glm(diagnosis ~ decay_fric1 + decay_fric2, family = binomial, data = .)
summary(logistic_model_voice2)

logistic_model_voice3 <- parkinsons_dataset %>% 
  glm(diagnosis ~ rel_loud_resp1 + rel_loud_resp2, family = binomial, data = .)
