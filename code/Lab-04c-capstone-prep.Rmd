...
rbd_test <- parkinsons_dataset[31:130,] %>%
...
rbd_test %>% 
  ggplot(aes(x = value, y = rbd, fill = rbd)) +
  ...
  labs(x = NULL, y = "Risk Status of Parkinson's Disease",  title = "Vocal Data of High Risk Patients Compared to Healthy Patients", fill = NULL) +
  theme_bw() +
