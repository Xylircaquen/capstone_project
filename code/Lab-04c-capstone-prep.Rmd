...
rbd_test <- parkinsons_dataset[31:130,] %>%
  pivot_longer(cols = c(52, 48, 50, 58, 53), names_to = "variable", values_to = "value")

facet_labels <- c(
  decay_fric1 = "Decay of Unvoiced Fricatives 1", # this one
  dur_pause_int1 = "Duration of Paused Intervals 1", # this one
  gap_voiced_int1 = "Gaping in-between Voiced Intervals 1", # this one
  rate_speech_time2 = "Rate of Speech Timing 2", # this one
  rel_loud_resp1 = "Relative Loudness of Resperation 1" #this one
)
...
rbd_test %>% 
  ...
  facet_wrap(~ variable, scales = "free_x", nrow = 1, ncol = 5, labeller = labeller(variable = facet_labels)) +
  labs(x = NULL, y = NULL,  title = "Vocal Data of High Risk Patients Compared to Healthy Patients", fill = NULL) +
  theme_bw() +
